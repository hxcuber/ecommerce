...
func (orderItemL) LoadOrder(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrderItem interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`orders`),
		qm.WhereIn(`orders.order_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func FindOrderItem(ctx context.Context, exec boil.ContextExecutor, orderID string, productID string, selectCols ...string) (*OrderItem, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"order_items\" where \"order_id\"=$1 AND \"product_id\"=$2", sel,
	)
...
func (o *OrderItem) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"order_items\" WHERE \"order_id\"=$1 AND \"product_id\"=$2"
...
func (o *OrderItem) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindOrderItem(ctx, exec, o.OrderID, o.ProductID)
	if err != nil {
		return err
	}
...
func OrderItemExists(ctx context.Context, exec boil.ContextExecutor, orderID string, productID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"order_items\" where \"order_id\"=$1 AND \"product_id\"=$2 limit 1)"
...
func (o *OrderItem) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return OrderItemExists(ctx, exec, o.OrderID, o.ProductID)
}
